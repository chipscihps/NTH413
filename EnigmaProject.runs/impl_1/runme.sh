...
HD_PWD='C:/Users/NTH413/EnigmaProject/EnigmaProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MainBlock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MainBlock.tcl -notrace
