...
HD_PWD='C:/Users/NTH413/EnigmaProject/EnigmaProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MainBlock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MainBlock.tcl
